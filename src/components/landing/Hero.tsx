...
import { Shield, Lock, Check, Camera, ChevronDown, FileText } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <motion.div
              variants={fadeInUp}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card shadow-sm mb-6"
            >
            ...
            >
              ...
              <a
                href="#how-it-works"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full glass-card text-snapid-text font-semibold text-lg hover:bg-zinc-800/80 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-snapid-bg"
              >
                See How It Works
            ...
            >
              ...
              <span className="font-medium text-emerald-400">100% private</span>
          ...
          >
            <div className="relative z-10">
              <div className="glass-card rounded-2xl shadow-2xl shadow-black/30 overflow-hidden border border-white/10">
                <div className="px-4 py-3 border-b border-white/10 flex items-center gap-2 bg-zinc-900/60">
                ...
                <div className="p-6 bg-zinc-900/60 backdrop-blur-md">
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="space-y-3">
                      <div className="p-3 rounded-lg bg-zinc-800/80 shadow-sm">
                        <div className="text-xs font-semibold text-snapid-text mb-2">Size</div>
                        <div className="space-y-1.5">
                          {['India (35×45mm)', 'US (2×2")', 'UK (35×45mm)'].map((size, i) => (
                            <div
                              key={size}
                              className={`text-xs px-2 py-1.5 rounded ${i === 0 ? 'bg-indigo-500/20 text-indigo-300 font-medium' : 'text-snapid-muted'}`}
                            >
                              {size}
                            </div>
                          ))}
